...
// Source: github.com/luislard/simplebank/db/sqlc (interfaces: Store)
...
// CreatAccount mocks base method.
func (m *MockStore) CreatAccount(arg0 context.Context, arg1 db.CreatAccountParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreatAccount", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreatAccount indicates an expected call of CreatAccount.
func (mr *MockStoreMockRecorder) CreatAccount(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreatAccount", reflect.TypeOf((*MockStore)(nil).CreatAccount), arg0, arg1)
}
